    ...
    const onFinish = (values) => {
        ...
        createContent(formData).unwrap()
            .then(() => {
                ...
                router.push(`/profile/my-content`)
            })
            .catch((error) => {
                    ...
                    <div className="flex gap-1 flex-nowrap xl:flex-wrap">
                        {interests.map((logo, index) => (
                            <div
                                ...
                                className={`flex items-center justify-center w-[120px] lg:w-[130px] h-[120px] lg:h-[130px] px-7 text-center cursor-pointer ${selectedLogos === logo.name
